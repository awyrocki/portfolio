  ...
  return (
    <>
      <Box sx={{mt: 1, ml: 1, mr: 1, pb: 2}} borderBottom={'1px solid #2f3542'}>
        ...
        <Typography color={"#e0e0e0"}>Application where users can send messages in live chat rooms together. Server build includes Node/Express framework for backend requests and Mongoose to model data. Endpoints persist to MongoDB, confirmed via MongoDB Atlas Cluster. Client side build includes React/React routing for user navigation. Components handle backend CRUD functionality to create an interactive and user-driven data management. Client authentication is a SSO modeled approach utilizing localStorage.</Typography>
