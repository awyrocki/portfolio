  ...
  return (
    <>
      <Box sx={{mt: 1, ml: 1, mr: 1, pb: 2}} borderBottom={'1px solid #2f3542'}>
        ...
        <Typography color={"#e0e0e0"}>Dynamic, mobile-first, comprehensive application featuring complete CRUD functionality and seamless Steam verification integration. Sleek UI design with content delivered via React Router components. Build includes Node for active runtime environment, Express framework handling backend requests, Mongoose schema for datamodeling and React/Material-UI for frontend</Typography>
